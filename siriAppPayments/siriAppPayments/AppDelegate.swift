...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    //When the applciation receives a user activity, it will bind the user activity to the userActivity of VC and call the showNotification method from the view controller
